...
# PROJECT CONTEXT - BACKEND OLT / NMS

## Project Overview

Nama project: backend-olt

Tujuan project adalah membangun NMS (Network Management System) untuk ISP berbasis OLT GPON dengan fokus pada:
...
* SweetAlert2
* Native HTML table jika sudah ada komponen UI
* Inline business logic yang berlebihan

---

# Frontend Architecture

Pattern frontend yang sedang digunakan:
...
Gunakan komponen shared sebelum membuat komponen baru.
...
Jangan membuat komponen UI custom jika sudah tersedia.
...
Project sudah mulai migrasi ke lazy loading menggunakan:

shared/lib/lazy-page.ts

Contoh:

const TelegramBotsPage =
lazyPage(
() => import('./pages/telegram-bots.page'),
'TelegramBotsPage'
)
...
Manajemen user Telegram yang diizinkan menggunakan bot.
...
Frontend sudah direfactor ke pattern modern.
...
Manajemen Telegram Bot untuk notifikasi dan command.
...
Frontend sudah direfactor dari multi-page menjadi single-page architecture.
...
Masih menggunakan pattern lama multi-page.

Target berikutnya:

Refactor ke Dialog + Sheet seperti Telegram Bot.
...
Backend sudah cukup matang.

Frontend masih minimal.

---

# ONU Replacement Module

Module:

modules/onu-replacement

Fungsi:

Tracking penggantian ONU pelanggan.

Status:

Perlu peningkatan UI.
...
* access-log-filter
* access-log-sort
* access-log-detail-sheet

Status:

Sedang dikembangkan.

Kemungkinan menjadi fokus berikutnya setelah Telegram Bot.
...
Migrasi aktif sampai:

Telegram Access Log

Sudah terdapat tabel untuk:
...
1. Telegram Access Logs
2. OLT Refactor
3. Endpoint Refactor
4. ONU Replacement UI Upgrade
5. Dashboard Enhancement

---

# Rules When Assisting This Project

Saat membantu project ini:

* Prioritaskan reuse shared components
* Gunakan shadcn/ui
* Gunakan TanStack Query
* Gunakan appToast
* Hindari SweetAlert2
* Hindari any
* Pertahankan named export
* Pertahankan module architecture
* Berikan code production-ready
* Berikan refactor bertahap (batch) jika perubahan besar

Anggap project ini adalah NMS ISP Production System dan bukan project belajar.
